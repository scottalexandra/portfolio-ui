Portfolio-ui is the client application for my personal website. The UI is cloned from a React/Reduxt starter application that utilizes Create React App. Setup instructions are below.
...
* **React Router v4** - The latest overhaul from [React Router](https://reacttraining.com/react-router/web). Please note that this library diverges significantly from previous versions.
...
* **Sass** - As mentioned above, custom-react-scripts are used to use [Sass](http://sass-lang.com/) within an unejected create-react-app.

* **react-md** - A material design (md) component library for React. View the docs [here](react-md.mlaursen.com).
...
*Everything below this point is generated by create-react-app.*
